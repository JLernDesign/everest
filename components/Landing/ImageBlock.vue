...
<template>
  ...
  >
    ...
    ></div>
    <div
      class="caption absolute bottom-[2rem] left-[2rem] pr-[2rem] font-barlow-cond text-sm-mob leading-[.94] text-white s:bottom-[5rem] s:left-[5rem] s:w-[50%] s:text-sm"
    >
      <IconTri color="fill-red" class="mb-8" />
      {{ data.caption }}
    </div>
  </div>
</template>
