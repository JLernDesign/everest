...
<template>
  <Section class="pb-[5rem] s:pb-section-bot">
    <div
      class="relative mx-auto max-w-base overflow-hidden rounded-base bg-shadowblue py-[4rem] s:py-[8.5rem]"
    >
      <SectionHeader
        :data="data.header"
        template="landing"
      ...
      <div class="mt-12 s:mt-side">
        ...
        >
          <div
            ...
            class="item w-full shrink-0 px-side-mob s:max-w-[78.6rem] s:px-[2.9rem]"
          >
            <div
        ...
        <div
          v-if="slider"
          class="mx-auto mt-side flex w-full max-w-[150rem] justify-center px-side"
        >
