...
<template>
  <div class="relative z-1 h-[19.2rem] w-[30.2rem] shrink-0" ref="main">
    <div
      class="relative z-1 h-[19.2rem] w-[30.2rem] cursor-pointer overflow-hidden rounded-base-mob p-[3.2rem] pt-[3.75rem] text-left s:rounded-base"
    ...
    <!-- case study link -->
    <div class="mt-10 w-full" v-if="data.cta">
      <!-- cta buttons -->
      <CtaGroup
        v-if="data.cta"
