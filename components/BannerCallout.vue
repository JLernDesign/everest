...
<template>
  <div class="relative p-side-mob s:px-side s:py-section-bot" ref="main">
    <!-- content -->
    <div
      class="relative z-1 flex flex-col justify-between overflow-hidden rounded-base-mob bg-shadowblue bg-[url(/images/ui/callout-texture-mob@2x.jpg)] bg-cover p-side-mob text-white s:flex-row s:rounded-base s:bg-[url(/images/ui/callout-texture@2x.jpg)] s:p-[7rem] s:pl-[11.5rem]"
    >
      <!-- text -->
      <div
      ...
      <!-- image 3D -->
      <div
        class="relative h-[16rem] w-full overflow-hidden rounded-base-mob bg-[url(/images/ui/callout-gradient@2x.png)] bg-cover s:h-[31rem] s:w-[59rem] s:rounded-base max-s:order-1"
      >
        <VideoAnim
