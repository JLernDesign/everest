...
<template>
  ...
  >
    <div
      class="menu-bg rounded-base-mob absolute left-1/2 -translate-x-1/2 bg-shadowblue bg-[url(/ui/menu-texture@2x.webp)] bg-cover p-[1.5rem] shadow-submenu s:rounded-base"
      :class="id == 'Product' ? 'w-[90rem]' : 'w-[41rem]'"
    >
      <ul
        class="menu-contents text-body-xsm-mob divide-y-1 divide-whiteline rounded-[.7rem] bg-shadowblue leading-sm text-white s:text-body-xsm"
        :class="
          id == 'Product' &&
