...
<template>
  ...
  >
    <div
      class="menu-bg shadow-submenu absolute left-1/2 -translate-x-1/2 rounded-base bg-shadowblue bg-[url(/ui/menu-texture@2x.webp)] bg-cover p-[1.5rem]"
      :class="id == 'Product' ? 'w-[90rem]' : 'w-[41rem]'"
    >
      <ul
        class="menu-contents divide-y-1 divide-whiteline rounded-[.7rem] bg-shadowblue text-body-xsm leading-sm text-white"
        :class="
          id == 'Product' &&
