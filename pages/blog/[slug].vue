...
<template>
  <div class="bg-jaffa pt-hero-top-mob s:pt-post-top" ref="main">
    ...
    >
      ...
      >
        <div
          class="article bullets s:min-h-[80rem] s:w-[84rem] [&_*+*]:mt-[1.8rem] [&_*+*]:s:mt-[3.2rem] [&_*+h2]:mt-[6rem] [&_*+h2]:s:mt-[9rem] [&_.blog-table_*+*]:mt-0 [&_a:not(.cta-btn):hover]:border-red [&_a:not(.cta-btn)]:border-b-1 [&_a:not(.cta-btn)]:border-b-transparent [&_a:not(.cta-btn)]:text-red [&_h2]:font-helvb [&_h2]:text-body-md-mob [&_h2]:s:text-body-md [&_h3+p]:mt-[.25rem] [&_h3+p]:s:mt-[.5rem] [&_h3]:font-helvb [&_ul]:space-y-[1rem]"
        >
